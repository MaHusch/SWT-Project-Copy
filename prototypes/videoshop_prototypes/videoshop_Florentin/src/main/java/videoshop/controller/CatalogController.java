...
class CatalogController {
	...
	@RequestMapping(value = "/removeDisc") //created by Florentin Dörre
	public String removeDisc(@RequestParam("pid") Disc disc)
	{
		DiscType type = disc.getType();
		
		//InventoryItem item = inventory.findByProduct(disc).orElse(null);
		//inventory.delete(item); // because inventory item with disc will cause an error otherwise
		videoCatalog.delete(disc);
