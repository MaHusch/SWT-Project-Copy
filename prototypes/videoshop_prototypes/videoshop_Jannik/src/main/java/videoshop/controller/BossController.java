...
class BossController {
	...
	public String restock(Model model) {
		...
		Iterable<InventoryItem> allitems =  inventory.findAll();
		
		Iterator<InventoryItem> itemiterator = allitems.iterator();
		...
		while(itemiterator.hasNext())
		{
			...
			if (quantity.isLessThan(quantity.of(10)))
				{
					item.increaseQuantity(quantity.of(5));
